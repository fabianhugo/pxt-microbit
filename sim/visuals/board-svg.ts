namespace pxsim.visuals {
    ...
    // Calliope mini v3 board artwork + geometry, extracted from microbit.ts.
    // The decorative SVG is static art; microbit.ts parses it and wires the
    // dynamic layer (LED matrix, RGB LEDs, buttons, pins, motors) programmatically.

    export const MB_WIDTH = 530;
    export const MB_HEIGHT = 630;

    export const BOARD_SVG_HEAD = `<?xml version="1.0" encoding="utf-8"?>
    ...
    export const BOARD_SVG_BOTTOM = `<g id="all">
	<g id="Batterie">
    ...
    export const BOARD_MINI2_BODY = `<style>#v3only,#hidden_v2,#TOUCH_LOGO{display:none;}</style><g id="v2">
	<g id="hidden_v2">
		<g id="C_P20">
    ...
    export const BOARD_MINI3_BODY = `<g id="v3">
    ...
    export const pinTitlesV2 = [
        "P0", "P1", "P2", "P3", "Logo", "GND", "+3v3",
        "Button A", "Button B",
        "GND", "GND", "GND", "+3v3",
        "P0", "P2", "C4", "C6", "C8", "C10", "C12", "C14", "C16 (A1 RX)", "C18 (A0 SDA)", "",
        "P1", "P3", "C5", "C7", "C9", "C11", "C13", "C15", "C17 (A1 TX)", "C19 (A0 SCL)",
        "", "", "MOTOR 0 +", "MOTOR 0 -", "MOTOR VM",
        "GND", "+3v3", "C18 (A0 SDA)", "C19 (A0 SCL)",
        "C16 (A1 RX)", "C17 (A1 TX)", "+3v3", "GND"
    ];

    // GPIO pin-header (Steckleiste) centres for the Calliope mini v2 artwork, in board SVG
    // coordinates. The v2 header sits lower and is laid out differently than v3, so parts/servo
    // cables wired via getCoord() must use these positions when the v2 board is shown. Values are
    // the C_Px pad circle centres from BOARD_MINI2_BODY (inner row y=439.6, outer row y=422.0).
    export const pinCoordsV2: pxsim.Map<[number, number]> = {
        "P0": [178.2, 439.6], "P1": [178.2, 422.0],
        "P2": [195.7, 439.6], "P3": [195.7, 422.0],
        "P4": [213.2, 439.6], "P5": [213.2, 422.0],
        "P6": [230.7, 439.6], "P7": [230.7, 422.0],
        "P8": [248.2, 439.6], "P9": [248.2, 422.0],
        "P10": [283.2, 439.6], "P11": [283.2, 422.0],
        "P12": [300.7, 439.6], "P13": [300.7, 422.0],
        "P14": [318.2, 439.6], "P15": [318.2, 422.0],
        "P16": [335.7, 439.6], "P17": [335.7, 422.0],
        "P18": [353.3, 439.6], "P19": [353.3, 422.0],
        "P20": [393.3, 422.0],
        // The physical GND1/VCC pads sit at the far-right of the v2 header; route their cables to
        // the left end instead (just before P0), offset 7px across the two rows so the +3v3/GND
        // cables don't overlap — matching the v3 simulator layout.
        "GND": [164.6, 439.6],   // inner row, nudged right
        "+3v3": [157.6, 422.0]   // outer row, nudged left
    };
